...
PRIVACY IS LOAD-BEARING (F123b, operator directive). This module:
  ...
  3. SANITIZES every projected string: forbidden network/family tokens (level-ID/Fundamental 10G/Fundamental 8G/
     contact-e/contact-f/HDFC/the operator) are stripped and dict keys carrying them are renamed. The public
     silver aggregate today leaks "level-ID-fib" (PEOPLE.md: network names must NEVER appear
...
# F123b). Case-insensitive; a trailing hyphen/space is absorbed so "level-ID-fib" -> "fib".
FORBIDDEN = ["Fundamental 10G", "Fundamental 8G", "level-ID", "contact-e", "contact-f", "HDFC", "the operator"]
